package com.example.refactoring.basic.combine_functions_into_transform;

import lombok.Getter;
import lombok.NoArgsConstructor;

@NoArgsConstructor(access = lombok.AccessLevel.PRIVATE)
public class AfterCombineFunctionIntoTransform {

    public static UsageCost usageCost(int usage) {
        return new UsageCost(usage);
    }
